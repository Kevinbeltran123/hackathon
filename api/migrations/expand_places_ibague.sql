...
-- SERVICIOS Y COMERCIOS (20+ lugares)
INSERT OR REPLACE INTO place (id, name, lat, lng, address, tags, barrio, base_duration, verified, description) VALUES

(301, 'Banco de Bogotá Centro', 4.4398, -75.1923, 'Carrera 3 #14-12, Centro', 'servicios', 'Centro', 15, 1, 'Servicios bancarios y cajeros'),
(302, 'Bancolombia Zona Rosa', 4.4512, -75.1734, 'CC La Estación, Local 105', 'servicios', 'Zona Rosa', 15, 1, 'Banco y servicios financieros'),
(303, 'Farmacia Colsubsidio', 4.4434, -75.1889, 'Carrera 2 #16-45, Centro', 'servicios', 'Centro', 10, 1, 'Medicamentos y productos de salud'),
(304, 'Droguería La Rebaja', 4.4489, -75.1756, 'CC Multicentro, Local 067', 'servicios', 'Zona Rosa', 10, 1, 'Farmacia y cosméticos'),
(305, 'Claro Tienda', 4.4456, -75.1812, 'Carrera 5 #22-78, Centro', 'servicios', 'Centro', 20, 1, 'Telefonía móvil y internet'),
(306, 'Movistar Centro', 4.4412, -75.1934, 'Calle 14 #4-56, Centro', 'servicios', 'Centro', 20, 1, 'Servicios de telecomunicaciones'),
(307, 'Servientrega Ibagué', 4.4445, -75.1867, 'Carrera 2 #18-34, Centro', 'servicios', 'Centro', 15, 1, 'Envíos y paquetería'),
(308, 'Inter Rapidísimo', 4.4423, -75.1901, 'Calle 15 #3-67, Centro', 'servicios', 'Centro', 15, 1, 'Giros y envíos nacionales'),
(309, 'Notaría Primera', 4.4389, -75.1945, 'Carrera 4 #13-12, Centro', 'servicios', 'Centro', 30, 1, 'Servicios notariales'),
(310, 'Registraduría Nacional', 4.4367, -75.1923, 'Calle 11 #3-45, Centro', 'servicios', 'Centro', 45, 1, 'Documentos de identidad'),
(311, 'Centro de Salud del Norte', 4.4612, -75.1834, 'Carrera 8 #46-12, Buenos Aires', 'servicios', 'Buenos Aires', 60, 1, 'Atención médica general'),
(312, 'Clínica Tolima', 4.4523, -75.1789, 'Calle 38 #9-67, Buenos Aires', 'servicios', 'Buenos Aires', 90, 1, 'Hospital privado'),
(313, 'Peluquería Estilos', 4.4434, -75.1878, 'Carrera 2 #17-23, Centro', 'servicios', 'Centro', 45, 1, 'Corte de cabello y estética'),
(314, 'Spa Relajarte', 4.4501, -75.1723, 'CC La Estación, Nivel 2', 'servicios', 'Zona Rosa', 90, 1, 'Masajes y tratamientos de belleza'),
(315, 'Lavandería Express', 4.4456, -75.1823, 'Carrera 5 #23-45, Centro', 'servicios', 'Centro', 20, 1, 'Lavado y planchado'),
(316, 'Óptica Los Andes', 4.4412, -75.1889, 'Calle 14 #3-78, Centro', 'servicios', 'Centro', 30, 1, 'Gafas y exámenes visuales'),
(317, 'Veterinaria San Francisco', 4.4578, -75.1798, 'Calle 41 #8-34, Buenos Aires', 'servicios', 'Buenos Aires', 45, 1, 'Atención veterinaria'),
(318, 'Taller Automotriz El Experto', 4.4234, -75.2045, 'Carrera 1 #12-67, Belén', 'servicios', 'Belén', 60, 1, 'Mecánica automotriz'),
(319, 'Ferretería El Constructor', 4.4367, -75.1956, 'Calle 11 #5-89, Centro', 'servicios', 'Centro', 25, 1, 'Herramientas y construcción'),
(320, 'Copymax Impresiones', 4.4445, -75.1834, 'Carrera 4 #19-45, Centro', 'servicios', 'Centro', 15, 1, 'Impresión y papelería');
...
-- ALOJAMIENTO Y HOSPEDAJE (10+ lugares)
INSERT OR REPLACE INTO place (id, name, lat, lng, address, tags, barrio, base_duration, verified, description) VALUES

(601, 'Hotel Dann Combeima', 4.4523, -75.1789, 'Carrera 9 #37-12, Buenos Aires', 'alojamiento', 'Buenos Aires', 60, 1, 'Hotel 5 estrellas, servicios ejecutivos'),
(602, 'Hotel Estelar Altamira', 4.4456, -75.1723, 'Calle 32 #10-89, Zona Rosa', 'alojamiento', 'Zona Rosa', 60, 1, 'Hotel boutique, vista panorámica'),
(603, 'Hotel Casa Morales', 4.4412, -75.1889, 'Carrera 3 #15-45, Centro', 'alojamiento,cultura', 'Centro', 45, 1, 'Hotel colonial, arquitectura tradicional'),
(604, 'Hostal Backpackers Ibagué', 4.4434, -75.1912, 'Calle 16 #2-78, Centro', 'alojamiento', 'Centro', 30, 1, 'Alojamiento económico para viajeros'),
(605, 'Hotel San Simón', 4.4367, -75.1934, 'Carrera 4 #11-67, Centro', 'alojamiento', 'Centro', 45, 1, 'Hotel familiar, precios accesibles'),
(606, 'Apart Hotel Los Nogales', 4.4589, -75.1756, 'Calle 42 #10-34, Buenos Aires', 'alojamiento', 'Buenos Aires', 60, 1, 'Apartamentos amoblados por días'),
(607, 'Hotel Lusitania', 4.4389, -75.1923, 'Plaza de Bolívar #3-45', 'alojamiento,historia', 'Centro', 45, 1, 'Hotel histórico frente a la plaza'),
(608, 'Hostal Villa María', 4.4234, -75.1823, 'Carrera 2 #10-89, Belén', 'alojamiento', 'Belén', 30, 1, 'Ambiente familiar, desayuno incluido'),
(609, 'Hotel Boutique La Estación', 4.4501, -75.1734, 'Calle 36 #9-56, Zona Rosa', 'alojamiento', 'Zona Rosa', 60, 1, 'Hotel moderno cerca del centro comercial'),
(610, 'Cabañas Combeima', 4.4156, -75.2345, 'Sector El Silencio, Combeima', 'alojamiento,naturaleza', 'Combeima', 90, 1, 'Cabañas ecológicas junto al río');
...
-- Agregar algunas actividades específicas para los nuevos lugares
INSERT OR REPLACE INTO activity (id, place_id, title, description, duration, tags, price, start_hour, end_hour) VALUES
(201, 101, 'Degustación de Lechona Tradicional', 'Prueba la auténtica lechona tolimense preparada con receta familiar', 45, 'gastro,cultura', 25000, '11:00', '21:00'),
(202, 402, 'Tour Histórico Plaza de Bolívar', 'Recorrido guiado por la historia de la plaza principal de Ibagué', 60, 'cultura,historia', 15000, '09:00', '17:00'),
(203, 501, 'Concierto en el Parque de la Música', 'Eventos musicales al aire libre en honor a la Capital Musical', 120, 'cultura,recreacion', 0, '18:00', '22:00'),
(204, 502, 'Sendero Ecológico Jardín Botánico', 'Caminata por los senderos del jardín botánico', 90, 'naturaleza,educacion', 8000, '08:00', '16:00'),
(205, 403, 'Función de Teatro', 'Obra teatral en el principal teatro de la ciudad', 120, 'cultura', 35000, '19:00', '21:30'),
(206, 513, 'Ecoturismo Cañón del Combeima', 'Aventura en el majestuoso cañón camino al Nevado del Tolima', 360, 'naturaleza,turismo', 85000, '06:00', '18:00'),
(207, 512, 'Relajación en Termales', 'Baño medicinal en aguas termales naturales', 180, 'naturaleza,turismo', 35000, '09:00', '18:00'),
(208, 406, 'Clase Magistral de Música', 'Aprende sobre la tradición musical tolimense', 90, 'cultura,educacion', 20000, '14:00', '17:00'),
(209, 201, 'Shopping en La Estación', 'Recorrido de compras en el principal centro comercial', 120, 'shopping,recreacion', 0, '10:00', '22:00'),
(210, 511, 'Mirador Cerro Martinica', 'Vista panorámica de Ibagué desde el cerro más emblemático', 120, 'naturaleza,turismo', 12000, '06:00', '18:00');
